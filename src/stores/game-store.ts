...
import type { RoomState, BlackjackState, PokerState, UnoState, HotPotatoState, Player } from '@/types'
...
interface GameStore {
  ...
  updateGameState: (gameState: BlackjackState | PokerState | UnoState | HotPotatoState) => void
